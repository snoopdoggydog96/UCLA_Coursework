...
***run the make dist command to create a tarball labeled lab3a-204419149.tar*** 
***run the command ./P3A_check.sh 204419149 to check functionality of the program against test cases***
