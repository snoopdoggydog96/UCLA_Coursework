...
/*declaring global lock for mutex ops */
...
/* cond_vars for spinLock with CAS and TS */
...
main(int argc, char **argv)
  {
    ...
    /*using getopt_long to parse commond line options and check for --bogus args */
     ...
     /* Start "stopwatch" to denote high resolution time for creating threads and having them perform specified operations */
     ...
     /* in nanoseconds so make sure to * by correct factor */
     struct timespec end;    
     ...
     /*
      Generate the output for the various different tests as specified by the Project2a spec
